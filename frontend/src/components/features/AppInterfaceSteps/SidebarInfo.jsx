    ...
    <div className="info-sidebar">
      ...
      <div className="sidebar-section">
        ...
        <div className="mini-info">
          ...
          <div className="info-item">
             <span>{t.sidebar_titles}</span>
            <strong>{translateStructuralTitles ? t.opt_translate : t.opt_preserve}</strong>
          </div>
          <div className="info-item">
             <span>{t.sidebar_ai_rewrite}</span>
            <strong>{enableAiRewrite ? t.opt_on : t.opt_off}</strong>
          </div>
        </div>
      </div>
    </div>
