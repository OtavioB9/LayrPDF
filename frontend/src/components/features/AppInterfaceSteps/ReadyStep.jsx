  ...
  return (
    ...
    >
      ...
      <div className="config-pills-stack">
        ...
        <motion.div className="title-policy-card" variants={fadeUp}>
          <label className="title-policy-toggle">
            <input
              type="checkbox"
              checked={translateStructuralTitles}
              onChange={(event) => setTranslateStructuralTitles(event.target.checked)}
            />
            <span className="title-policy-switch" />
            <span className="title-policy-text">{t.config_translate_titles}</span>
          </label>
        </motion.div>
        ...
        <motion.div className="title-policy-card" variants={fadeUp}>
          <label className="title-policy-toggle">
            <input
              ...
              onChange={(event) => setEnableAiRewrite(event.target.checked)}
            />
            <span className="title-policy-switch" />
            <span className="title-policy-text">{t.config_ai_rewrite}</span>
          </label>
        </motion.div>
      </div>
